...
(Color, Color) repairStatusContainerColors(
  RepairStatus status,
  ColorScheme cs,
) => switch (status) {
  RepairStatus.received => (cs.tertiaryContainer, cs.onTertiaryContainer),
  RepairStatus.waitingForMaterials => (cs.errorContainer, cs.onErrorContainer),
  ...
  RepairStatus.returned => (cs.surfaceContainerHighest, cs.onSurfaceVariant),
};
